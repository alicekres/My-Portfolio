                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardBack}>
                        ...
                        <p className={styles.projectDescription}>
                            The London journal is an awesome application in case
                            travelling to London is in your mind. The London
                            Journal helps you to find out about people's
                            experiences there and make up your mind about places
                            to visit and places to avoid. Not only that, you
                            yourself feel free to leave advice for others!
                        </p>
            ...
            <div className={styles.flipCard}>
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardBack}>
                        <h3>Habit Tracker</h3>
                        <p className={styles.projectDescription}>
                            Habit tracker is an application that allows you to
                            pick up a new habit. You can write down your new
                            commitment and frequency of which you wish the habit
                            to happen. It's a good start when you want to turn
                            your life around!
                        </p>
                        <div className={styles.buttons}>
                            <a
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardBack}>
                        ...
                        <p className={styles.projectDescription}>
                            ...
                            There is a choice of "Local game", online room and
                            "Ranking game". You can choose between 5 different
                            topics and difficulty level. Go ahead and enjoy!
                        </p>
                        <div className={styles.buttons}>
                            <a
                                className={styles.button}
            ...
            <div className={styles.flipCard}>
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardBack}>
                        <h3>Random Blogs</h3>
                        <p className={styles.projectDescription}>
                            Random Blogs is an application that allows the owner
                            of the page write blogs and thoughts about life and
                            everything that comes with it. For users who come to
                            read the blogs there is an opportunity to contact
                            the owner.
                        </p>
                        <div className={styles.buttons}>
                            <a
